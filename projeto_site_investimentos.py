# -*- coding: utf-8 -*-
"""
Created on Mon Feb 17 23:46:43 2025
        ...
        with st.spinner('Baixando dados e otimizando...'):
            ...
            if data.empty:
                ...
                if optimized_results.success:
                    ...
                    volatilidades_carteiras = np.sqrt(np.sum(pesos_carteiras @ matriz_covariancia * pesos_carteiras, axis=1))
...
with tabs[2]:
    ...
    with col3:
        backtest_start = st.date_input('Data de Início do Backtest', datetime.today() - timedelta(days=5*365), key='bt_start')
    with col4:
